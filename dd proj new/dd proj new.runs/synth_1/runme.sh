...
HD_PWD='D:/program/vivado/dd proj new/dd proj new.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wordle.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wordle.tcl
