...
HD_PWD='D:/program/vivado/dd proj new/dd proj new.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wordle.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wordle.tcl -notrace
